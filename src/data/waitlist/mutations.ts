...
import { WelcomeEmailOne, WelcomeEmailThree, WelcomeEmailTwo } from "@/components/features/email/welcome-emails";
...
async function scheduleWelcomeEmails(email: string, firstName: string) {
